...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Repo = __webpack_require__(321);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class, _temp; /* eslint-disable jsx-a11y/aria-role */
	...
	var _NavLink = __webpack_require__(309);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
	  return _react2.default.createElement(_reactRouter.Link, (0, _extends3.default)({}, props, { activeClassName: 'active' }));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".active {\n  font-weight: bold; }\n\nhtml {\n  font-size: 16px; }\n\n.task {\n  display: flex;\n  flex-direction: row;\n  padding: 4px;\n  position: relative;\n  min-height: 36px;\n  margin: 4px; }\n\n.task__header {\n  min-height: 36px;\n  align-items: stretch; }\n\n.task__title {\n  font-size: 1.5rem;\n  position: absolute;\n  top: 0;\n  left: 0;\n  padding: 4px; }\n\n.task__time {\n  font-size: 1.5rem;\n  position: absolute;\n  top: 0;\n  right: 4rem;\n  padding: 4px; }\n\n.task__description {\n  font-size: 1.0rem;\n  position: absolute;\n  top: 2rem;\n  left: 0;\n  padding: 4px; }\n", "", {"version":3,"sources":["/./stylesheets/stylesheets/index.scss"],"names":[],"mappings":"AACA;EACI,kBAAkB,EACrB;;AAED;EACE,gBAAgB,EACjB;;AAED;EACE,cAAc;EACd,oBAAoB;EACpB,aAAa;EACb,mBAAmB;EACnB,iBAAiB;EACjB,YAAY,EACb;;AAED;EACE,iBAAiB;EACjB,qBAAqB,EACtB;;AAED;EACE,kBAAkB;EAClB,mBAAmB;EACnB,OAAO;EACP,QAAQ;EACR,aAAa,EACd;;AAED;EACE,kBAAkB;EAClB,mBAAmB;EACnB,OAAO;EACP,YAAY;EACZ,aAAa,EACd;;AAED;EACE,kBAAkB;EAClB,mBAAmB;EACnB,UAAU;EACV,QAAQ;EACR,aAAa,EACd","file":"index.scss","sourcesContent":["// TODO: create directories, write scss, setup webpack\n.active {\n    font-weight: bold;\n}\n\nhtml {\n  font-size: 16px;\n}\n\n.task {\n  display: flex;\n  flex-direction: row;\n  padding: 4px;\n  position: relative;\n  min-height: 36px;\n  margin: 4px;\n}\n\n.task__header {\n  min-height: 36px;\n  align-items: stretch;\n}\n\n.task__title {\n  font-size: 1.5rem;\n  position: absolute;\n  top: 0;\n  left: 0;\n  padding: 4px;\n}\n\n.task__time {\n  font-size: 1.5rem;\n  position: absolute;\n  top: 0;\n  right: 4rem;\n  padding: 4px;\n}\n\n.task__description {\n  font-size: 1.0rem;\n  position: absolute;\n  top: 2rem;\n  left: 0;\n  padding: 4px;\n}"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repos = function (_Component) {
	  ...
	  function Repos() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (Repos.__proto__ || (0, _getPrototypeOf2.default)(Repos)).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorPalette = __webpack_require__(323);

	var _taskSort = __webpack_require__(327);
	...
	exports.default = (0, _colorPalette.colorPalette)(_class = function (_Component) {
	  ...
	  function Home() {
	    ...
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Home.__proto__ || (0, _getPrototypeOf2.default)(Home)).call.apply(_ref, [this].concat(args))), _this), _this.task_array = [{
	  ...
	  (0, _createClass3.default)(Home, [{
	    ...
	    value: function generateTasks() {
	      return (0, _taskSort.taskSort)(this.task_array).map(function (props, keyIndex) {
	        return _react2.default.createElement(_Task2.default, (0, _extends3.default)({ key: keyIndex }, props));
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var tasks = this.generateTasks();
	      // TODO: make the actual number of time
	      var remainingTime = 'Remaining time: ' + (0, _utils.toStringTime)(157);

	      // TODO: check to see if the task is complete before including it
	      var tasksLeft = 'Tasks left: ' + this.task_array.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var color_names = (0, _keys2.default)(COLORS);
	var num_colors = color_names.length;

	function colorPalette(target) {
	  target.currentColorIndex = 0;

	  /**
	   * Returns the next color as a hex string '#@@@@@@'
	  **/
	  target.getNextColor = function () {
	    var nextColor = COLORS[color_names[target.currentColorIndex]];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dateSort(tasks) {
	  return tasks.sort(function (task1, task2) {
	    return (0, _utils.compareDate)(task1.dueDate, task2.dueDate);
	  });
	}

	var taskSort = exports.taskSort = dateSort;
...
/***/ function(module, exports) {
	...
	exports.toStringTime = toStringTime;
	exports.compareDate = compareDate;
	function toStringTime(minutes) {
	  if (minutes < 60) {
	    return minutes + " min";
	  }
	  var hours = Math.floor(minutes / 60);
	  var remainder = minutes - hours * 60;
	  return hours + " hr " + remainder + " min";
	}

	function compareDate(date1, date2) {
	  var month1 = parseInt(date1.substring(0, 2), 10);
	  var month2 = parseInt(date2.substring(0, 2), 10);

	  var day1 = parseInt(date1.substring(3, 5), 10);
	  var day2 = parseInt(date2.substring(3, 5), 10);

	  var year1 = parseInt(date1.substring(6, 8), 10);
	  var year2 = parseInt(date2.substring(6, 8), 10);

	  var hash1 = year1 * 10000 + month1 * 100 + day1;
	  var hash2 = year2 * 10000 + month2 * 100 + day2;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Task = (_temp2 = _class = function (_Component) {
	  ...
	  function Task() {
	    ...
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Task.__proto__ || (0, _getPrototypeOf2.default)(Task)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	  ...
	  (0, _createClass3.default)(Task, [{
	    key: 'expandedContent',
	    value: function expandedContent() {
	    ...
	    value: function render() {
	      ...
	      var estimate = _props.estimate;
	      var completed = _props.completed;
	      var dueDate = _props.dueDate;
	      var color = _props.color;
	      /* eslint-enable */

	      var content = this.state.expanded ? this.expandedContent() : '';

	      return _react2.default.createElement(
	        'div',
	        { className: 'task', style: { backgroundColor: this.props.color } },
	        _react2.default.createElement(
	          'div',
	          { className: 'task__header', tabIndex: '0', onClick: this.toggleExpanded },
	          _react2.default.createElement(
	            'span',
	          ...
	          _react2.default.createElement(
	            ...
	            (0, _utils.toStringTime)(estimate)
	          )
	        ),
	        content
	      );
	  ...
	  estimate: _react.PropTypes.number.isRequired,
